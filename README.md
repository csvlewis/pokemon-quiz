...
This project is a Pokémon quiz app built using Next.js. The quiz question data is generated by fetching random Pokémon data from the <a href="https://github.com/PokeAPI/pokedex-promise-v2">Pokémon API</a>. That Pokémon data is then converted into a question related to the Pokémon's type, abilties, etc. which is used as part of the quiz.
